...
static int8_t qrcode_initBytes(QRCode *qrcode, uint8_t *modules, uint8_t version, uint8_t ecc, uint8_t *data, uint16_t length) {
    uint8_t size = version * 4 + 17;
...
static bool qrcode_getModule(QRCode const *qrcode, uint8_t x, uint8_t y) {
...
static std::string tosvgstring(QRCode const& qrcode, int border){
